...
function draw() {
 background(0);
  ...
  if (World.frameCount % 100 == 0) {
   ...
   case 1: select_balloon.addImage(red_balloonImage);
    break;
   case 2: select_balloon.addImage(blue_balloonImage);
    break;
   case 3: select_balloon.addImage(green_balloonImage);
    break;
   case 4: select_balloon.addImage(pink_balloonImage);
    break;
  }
 }
